...
public:
    ...
    {
        BatchProcessor->setWindowTitle(QCoreApplication::translate("BatchProcessor", "QModBus Batch Processor", nullptr));
        label_3->setText(QCoreApplication::translate("BatchProcessor", "Interval (in seconds)", nullptr));
        label_5->setText(QCoreApplication::translate("BatchProcessor", "Function code", nullptr));
        functionCode->setItemText(0, QCoreApplication::translate("BatchProcessor", "Read Coils (0x01)", nullptr));
        functionCode->setItemText(1, QCoreApplication::translate("BatchProcessor", "Read Discrete Inputs (0x02)", nullptr));
        functionCode->setItemText(2, QCoreApplication::translate("BatchProcessor", "Read Holding Registers (0x03)", nullptr));
        functionCode->setItemText(3, QCoreApplication::translate("BatchProcessor", "Read Input Registers (0x04)", nullptr));
        functionCode->setItemText(4, QCoreApplication::translate("BatchProcessor", "Write Single Coil (0x05)", nullptr));
        functionCode->setItemText(5, QCoreApplication::translate("BatchProcessor", "Write Single Register (0x06)", nullptr));
        functionCode->setItemText(6, QCoreApplication::translate("BatchProcessor", "Write Multiple Coils (0x0f)", nullptr));
        functionCode->setItemText(7, QCoreApplication::translate("BatchProcessor", "Write Multiple Registers (0x10)", nullptr));

        label_4->setText(QCoreApplication::translate("BatchProcessor", "Output file", nullptr));
        openOutputFileButton->setText(QCoreApplication::translate("BatchProcessor", "...", nullptr));
        label_6->setText(QCoreApplication::translate("BatchProcessor", "IDs && registers", nullptr));
        startButton->setText(QCoreApplication::translate("BatchProcessor", "Start", nullptr));
        stopButton->setText(QCoreApplication::translate("BatchProcessor", "Stop", nullptr));
        closeButton->setText(QCoreApplication::translate("BatchProcessor", "Close", nullptr));
    } // retranslateUi
