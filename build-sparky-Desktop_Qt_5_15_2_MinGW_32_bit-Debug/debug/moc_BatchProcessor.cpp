...
#include <memory>
#include "../../Sparky/src/BatchProcessor.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BatchProcessor_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BatchProcessor_t qt_meta_stringdata_BatchProcessor = {
    {
QT_MOC_LITERAL(0, 0, 14), // "BatchProcessor"
QT_MOC_LITERAL(1, 15, 5), // "start"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4), // "stop"
QT_MOC_LITERAL(4, 27, 16), // "browseOutputFile"
QT_MOC_LITERAL(5, 44, 8) // "runBatch"

    },
    "BatchProcessor\0start\0\0stop\0browseOutputFile\0"
    "runBatch"
};
...
QT_INIT_METAOBJECT const QMetaObject BatchProcessor::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_BatchProcessor.data,
    qt_meta_data_BatchProcessor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *BatchProcessor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BatchProcessor.stringdata0))
